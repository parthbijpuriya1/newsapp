...
HANDLE console = GetStdHandle(STD_OUTPUT_HANDLE); // Fixed typo in GetStdHandle
...
void gameOver() { // Corrected function name
    system("cls");
    cout << endl;
    cout << "\t\t--------------------------" << endl;
    cout << "\t\t------- Game Over -------" << endl;
...
int main() { // Corrected the main function signature
    setcursor(0, 0);
